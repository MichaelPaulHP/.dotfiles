...
change_xfterm () {
	...
	sed -i -e 's/ColorForeground=.*/ColorForeground=#8D8D78785656/g' "$xfce_term_path"/terminalrc
...
change_bar 'hello' 'Iosevka Nerd Font:size=10;3' && "$polybar_path"/launch.sh		# STYLE | FONT

## Change colors in funct (ROFI)
change_rofi 'hello' 'Iosevka 10' '0px' 'Numix-Apps'								# STYLE/DIR | FONT | BORDER | ICON

change_nm 'hello'																	# CONFIG FILE DIR
...
change_gtk 'Kripton' 'Archcraft-Dark' 'Nordic-Cursor' 'Iosevka Custom 10'					# THEME | ICON | CURSOR | FONT

## Change margin in funct (OPENBOX) w-space
## obconfig 'Nordic' 'LIMC' 'Noto Sans' '0' && openbox --reconfigure					# THEME | LAYOUT | FONT |SIZE
obconfig 'Arc' 'LIMC' 'Iosevka' '11' && openbox --reconfigure					# THEME | LAYOUT | FONT |SIZE
